...
_CTX_PATH = "src.infrastructure.rest.routers.assurance._neighbors_routes.get_assurance_context"
...
class TestBudgets:
    def test_node_budget_truncates_with_frontier(self, seeded, monkeypatch) -> None:  # type: ignore[no-untyped-def]
        import src.infrastructure.rest.routers.assurance._neighbors_routes as routes
