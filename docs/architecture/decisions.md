...
| [Two-tier repositories & promotion](../../engagements/ENG-ARCH-REPO/architecture-repository/docs/adr/tiering-and-cross-tier-change/ADR@1783406774.id7tSC.two-tier-repositories-with-promotion-as-the-governance-gate.md) | Autonomous engagement repos; one curated enterprise baseline; promotion as the governance gate |
...
| [The scratchpad tier](../../engagements/ENG-ARCH-REPO/architecture-repository/docs/adr/platform-core/ADR@1786233058.fWkHZrZ.the-scratchpad-a-preliminary-tier-that-lifts-into-the-model-never-syncs-with-it.md) | A preliminary tier held beside the model: untyped notes refined along the meta-ontology's own hierarchy, lifted through the ordinary verified write path, never synced back |
