...
class RelationshipGraph(Protocol):
    ...
    #: Documents whose markdown links point at this entity's file. Documents sit beside the model
    #: and reference it one-way, so this is the only direction the question can be asked from.
