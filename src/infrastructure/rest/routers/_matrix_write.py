...
from src.infrastructure.rest.routers._diagram_write_bodies import (
    CreateMatrixBody,
    EditMatrixBody,
    MatrixPreviewBody,
)
from src.infrastructure.rest.routers._diagram_write_responses import (
    CREATE_RESPONSES,
    DETAIL_RESPONSES,
    created,
)
from src.infrastructure.rest.routers._matrix_markdown import build_matrix_markdown
