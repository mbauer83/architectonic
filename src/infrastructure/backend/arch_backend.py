...
from src.infrastructure.backend._startup_repository import initialise_repo, run_startup_validations
...
def _run_foreground(args: argparse.Namespace, parser: argparse.ArgumentParser, resolved_port: int) -> None:
    ...
    repo = initialise_repo(repo_root_path, enterprise_root_path, args)
    run_startup_validations(repo)
