...
def register(mcp: FastMCP) -> None:
    ...
    register_mutation_tool(
        ...
        description=(
            ...
            "specializations accepts SEVERAL slugs (ArchiMate 15.2): a connection may be several kinds "
            "at once, and since identity is (source, target, type), two connections differing only in "
            "specialization would read as a duplicate — carry both on one connection instead. "
