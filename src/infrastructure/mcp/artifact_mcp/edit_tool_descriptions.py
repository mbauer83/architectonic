...
EDIT_DIAGRAM_DESCRIPTION = (
    ...
    "entity_ids/connection_ids without puml update only bindings, not the body (edit, unlike "
    "create, never regenerates a body from entity_ids). Frontmatter fields "
